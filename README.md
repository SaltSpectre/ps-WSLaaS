...
You can download this repository or use `git clone https://github.com/SaltSpectre/ps-WSLaaS.git`. All files, including the configuration file and icons are included.
